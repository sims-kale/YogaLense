...
flitered_dataset_path = r"D:\SHU\Applied ai\Assesment\datasets\test"

# Main logger
# Preprocessing logger
preprocessing_logger = logging.getLogger("preprocessing")
preprocessing_handler = logging.FileHandler(r"D:\SHU\Applied ai\Assesment\results\test\logs\preprocessing.log", mode="w")
...
feature_engg_handler = logging.FileHandler(r"D:\SHU\Applied ai\Assesment\results\test\logs\feature_engg.log", mode="w")
...
def main():
    ...
    from src.prepocessor import preprocess_data, extract_keypoints
    from src.feature_engineering import feature_engg, save_features_to_csv
    ...
    try:
        ...
        output_csv_path = r"D:\SHU\Applied ai\Assesment\results\test\pose_features_with_labels.csv"
